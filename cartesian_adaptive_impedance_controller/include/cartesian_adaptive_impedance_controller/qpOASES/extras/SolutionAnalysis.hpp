...
/**
 *	\file include/cartesian_adaptive_impedance_controller/qpOASES/extras/SolutionAnalysis.hpp
...
#include <cartesian_adaptive_impedance_controller/qpOASES/extras/SolutionAnalysis.ipp>
