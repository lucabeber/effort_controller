...
namespace franka_coppelia_hw
{
  ...
  hardware_interface::CallbackReturn FrankaEffortHardware::on_init(
  ...
  {
    RCLCPP_INFO(
        rclcpp::get_logger("FrankaEffortHardware"), "Configuring ...please wait...");
  ...
  {
    RCLCPP_INFO(
        rclcpp::get_logger("FrankaEffortHardware"), "Activating ...please wait...");
      ...
      const rclcpp_lifecycle::State & /*previous_state*/)
  {
    // BEGIN: This part here is for exemplary purposes - Please do not copy to your production code
    RCLCPP_INFO(
        rclcpp::get_logger("FrankaEffortHardware"), "Deactivating ...please wait...");
    ...
    RCLCPP_INFO(rclcpp::get_logger("FrankaEffortHardware"), "Successfully deactivated!");
    // END: This part here is for exemplary purposes - Please do not copy to your production code

    return hardware_interface::CallbackReturn::SUCCESS;
  }

  hardware_interface::return_type FrankaEffortHardware::read(
  ...
  hardware_interface::return_type FrankaEffortHardware::write(
      const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
  {
...
PLUGINLIB_EXPORT_CLASS(
    franka_coppelia_hw::FrankaEffortHardware, hardware_interface::SystemInterface)
