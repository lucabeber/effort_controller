...
#include "franka_coppelia_hw/visibility_control.h"
...
class FrankaEffortHardware : public hardware_interface::SystemInterface
{
public:

  RCLCPP_SHARED_PTR_DEFINITIONS(FrankaEffortHardware);
